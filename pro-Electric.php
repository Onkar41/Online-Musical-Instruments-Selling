...
<style>
  ...
  .pagination-outer{ text-align: center;margin-left: 400px; }
.pagination{
...
<div class="demo mt-3 ">
  <nav class="pagination-outer " aria-label="Page navigation">
    <ul class="pagination">
      ...
      <li class="page-item ms-2"><a class="page-link" href="pro-Electric.php">Electric</a></li>
          ...
          <div class="card-body">
            <div class="row">
              ...
              <div class="col-md-6 col-lg-3 col-xl-3 border-sm-start-none border-start">
                ...
                <a href="pro-Electric.php?crt=<?php echo $row['product_id'];?>">
